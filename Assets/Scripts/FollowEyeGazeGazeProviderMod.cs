...
namespace Microsoft.MixedReality.Toolkit.Examples.Demos.EyeTracking
{
    ...
    public class FollowEyeGazeGazeProviderMod : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            {
                gameObject.transform.position = gazeProvider.HitPosition; // gazeProvider.GazeOrigin + gazeProvider.GazeDirection.normalized * defaultDistanceInMeters;
            }
        }
    }
}